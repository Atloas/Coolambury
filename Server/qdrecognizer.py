...
class QDRecognizer:
    ...
    def guess(self):
        drawings = []
        drawings.append(self.drawing)

        appropriate_list = self.convert_strokes_list(drawings)
...
if __name__ == '__main__': 
    ...
    stroke11 = [(7, 4), (14, 38), (22, 49), (38, 60), (90, 80), (147, 88), (175, 88), (201, 79), (233, 51), (250, 29), (255, 14), (245, 11), (175, 9), (73, 0), (0, 1)], [(71, 80), (69, 96), (72, 101), (96, 111), (179, 119), (184, 114), (182, 98)], [(74, 105), (39, 105), (20, 107), (15, 110), (11, 116), (10, 142), (19, 155), (35, 160), (211, 169), (224, 148), (229, 127), (221, 122), (178, 119)]
    ...
    qd.add_stroke(stroke2)
    print(qd.guess())
    # qd.add_stroke(stroke11)
    # print(len(qd.drawing))
    # print("------------")
    # print(qd.drawing)
    # print("------------")
    qd.add_stroke(stroke3)
    print(qd.guess())
