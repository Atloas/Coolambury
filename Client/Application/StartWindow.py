...
class StartWindow(QtWidgets.QWidget):
    ...
    def delegate_room_join_to_handler(self):
        if self.validate_nickname() and self.validate_room_code():
            ...
            self.connection_handler.send_join_room_req(self.client_context['username'], self.client_context['roomCode'])
    ...
    def room_list_element_clicked(self, item):
        ...
        logging.debug('[ROOM LIST CLICKED] clicked: {},'.format(item.text()[-8:], fetched_room_code))
